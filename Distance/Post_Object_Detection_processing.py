...
#final_image=cv2.drawKeypoints(gray,kp)
#cv2.imwrite('sift_keypoints.jpg',final_image)

fimage=np.zeros(500)
final_image=cv2.drawKeypoints(gray,kp,fimage,flags=cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
